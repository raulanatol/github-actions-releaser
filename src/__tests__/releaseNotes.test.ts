import { getLatestReleaseDate, issuesToReleaseNotes, toReleaseNotesIssues, toReleaseNoteText } from '../releaseNotes';
import { IssueToRelease } from '../models';
      ...
      const issues: IssueToRelease[] = [
        {
          ...
          title: 'Bug 1',
          user: 'testUser1',
          url: 'https://github.com/issue/issue_1',
          type: 'bug',
        },
        {
          id: 2845,
          title: 'Bug 2',
          user: 'testUser2',
          url: 'https://github.com/issue/issue_2',
          type: 'bug',
        },
        {
          id: 2145,
          title: 'Feature 1',
          user: 'testUser23',
          url: 'https://github.com/issue/issue_3',
          type: 'feature',
        },
        {
          id: 234,
          title: 'Bug 3',
          user: 'testUser3',
          url: 'https://github.com/issue/issue_4',
          type: 'bug',
        },
        {
          id: 23214,
          title: 'Feature 21',
          user: 'testUser1',
          url: 'https://github.com/issue/issue_5',
          type: 'feature',
        },
        {
          id: 12,
          title: 'Other 1',
          user: 'testUser1',
          url: 'https://github.com/issue/issue_6',
          type: 'other',
        },
        {
          id: 1020,
          title: 'test: 1',
          user: 'testUser3',
          url: 'https://github.com/issue/issue_19',
          type: 'test',
        },
      ] as IssueToRelease[];
